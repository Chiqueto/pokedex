    ...
    return (
        <li key={pokemon.id} className="w-full h-full">
            <div className="flex flex-row max-h-28 relative h-full items-center justify-center group">
                ...
                <div className="relative overflow-hidden w-full max-h-28 h-full py-0.5 px-4 flex flex-col justify-between rounded-l-xl bg-gray-base transition-colors duration-500 group-hover:text-white">
                    {/* Pseudo-elemento para o efeito de transição */}
                    <div className="absolute inset-0 bg-base-red scale-x-0 origin-right transition-transform duration-500 group-hover:scale-x-100"></div>
                ...
                <div className="bg-base-red w-full z-20 h-28 rounded-r-xl">
                    <div className="relative flex items-center justify-end mx-4 h-full max-h-28">
                        <img
                            ...
                            alt={pokemon.name}
                            className="max-h-32 h-full z-30 mr-2 object-fill"
                        />
